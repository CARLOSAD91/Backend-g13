...
class App extends Component {
  ...
  editar(cod, index){
    axios.get('http://127.0.0.1:8000/api/serie/'+ cod)
    .then(res => {
      this.setState({
        post:index,
        titulo: 'Editar',
  ...
  guardar(e){
    ...
    if(cod > 0){
      // actualizar
      axios.put('http://127.0.0.1:8000/api/serie/'+ cod, datos)
      .then(res => {
      ...
      // nuevo registro
      axios.post('http://127.0.0.1:8000/api/series/', datos)
      .then(res =>  {
    ...
    <div>
      ...
      <Form onSubmit={this.guardar}>
        ...
        <Form.Group className='mb-3'>
          ...
          <Form.Control type='text' value={this.state.raiting} onChange={this.cambioRating}/>
        </Form.Group>
        <Form.Group className='mb-3'>
